...
--
-- Host: localhost:3306
-- Generation Time: Feb 18, 2025 at 06:25 AM
...
(1212, 'admin', '1212', 'admin', 'admin'),
(2121, 'petugas', '2121', 'petugas', 'petugas');
...
--
ALTER TABLE `petugas`
  MODIFY `id_petugas` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2122;
